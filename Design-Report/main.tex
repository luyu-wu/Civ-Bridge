...
We also realized that removing the bottom shifts the centroid up. This has 2 effects. First, it decreases the distance from the centroid, through $\sigma = \dfrac{My}{I}$ this decreases the stress. Second, it decreases the MOI as the distance of the deck is closer to the centroid.
