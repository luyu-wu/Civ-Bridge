...
of this project, we chose rectangular for the simplified geometry and load profiles. Since the track width must be at least 100 mm wide at any point, we allowed the HSS to be 100mm x 100mm x 1.27mm. This is the most simple cross section,
...
\begin{center}
    \textbf{Re-added the bottom layer and recalculated required layer lengths (Figure \ref{fig:Final diagram - cross-section}, \ref{fig:Final diagram - top layer}).}
\end{center}
